...
import Profileimg1 from ".././public/prarthana.jpg";
        ...
        <div className="md:px-10 flex flex-col items-center justify-center gap-4 mx-6 lg:mx-32">
          ...
          <div className="flex flex-col gap-2 justify-items-center justify-center mx-3">
            <p className="text-sm text-litepurple">
              ...
              Prarthana Agrawal. I am a passionate front-end web developer, specifically,
              ...
              Spend time solving coding problems on websites like LeetCode, HackerRank and 
              CodeChef to build your problem-solving and coding skills. 
              Take part in online coding competitions and hackathons to learn from other 
              participants and to get comfortable with the competitive environment.
            </p>
            {/* <p className="text-sm text-litepurple">
